...
- (void)enableMyMoToAllowSendMoney:(CDVInvokedUrlCommand*)command
{
    ...
    NSUserDefaults *userDefaults = [[NSUserDefaults alloc] initWithSuiteName:@"group.idmission.MyMoDemo"];
...
- (NSString*)getDocumentPath_For_ImageName:(NSString*)imageName imageData:(NSData*)imagedata {
    ...
    NSURL *documentURL = [[NSFileManager defaultManager] containerURLForSecurityApplicationGroupIdentifier:@"group.idmission.MyMoDemo"];
